...
13)Problema 12 pero en formato long double 
...
caso2(long double B[length][nvectors], long double C[nvectors])
{
  int i, j;
  
  long double A[length][nvectors];
...
int main(int argc, char **argv){
  ...
  /////////////////////////////////////
  long double C[nvectors];
  long double B[length][nvectors];
